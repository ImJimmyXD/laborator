namespace L05
{
    ...
    {
        /// <summary>
        /// Defines the studentsTable_.
        /// </summary>
        private static CloudTable studentsTable_;

        /// <summary>
        /// Defines the raportTable_.
        /// </summary>
        ...
        /// The GetAllStudents.
        /// </summary>
        /// <returns>The <see cref="Task{List{Student}}"/>.</returns>
        ...
        /// The CreateRaport.
        /// </summary>
        /// <param name="raport">The raport<see cref="RaportEntity"/>.</param>
        /// <returns>The <see cref="Task"/>.</returns>

...
namespace L03
{
    public class Program
    {
        ...
        static string ApplicationName = "DAC_L03";
        ...
        public static void Main(string[] args)
        {
            ...
            FileStream file =
                File.OpenRead(@"C:\Users\Simi\Desktop\Facultate\An 4 Sem 1\DAC\laborator\Simion Andrei\L03\file.txt");
        ...
        {
            using (var stream =
                new FileStream("C:\\Users\\Simi\\Desktop\\Facultate\\An 4 Sem 1\\DAC\\laborator\\Simion Andrei\\L03\\credentials.json", FileMode.Open, FileAccess.Read))
            {
        ...
        {
            string filepath = @"C:\Users\Simi\Desktop\Facultate\An 4 Sem 1\DAC\laborator\Simion Andrei\L03\file.txt";
